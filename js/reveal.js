...
(function( root, factory ) {
	...
	function setDomTransition(list,transitionSpeed) {
		for (let i = 0; i < list.length; i++) {
			list[i].style.transitionDuration = transitionSpeed;
		}
	}
	/**
	...
	function configure( options ) {
		...
		if(typeof config.transitionSpeed == 'number') {
			console.log(document.querySelectorAll('.reveal .slides section'));
			let s = `${config.transitionSpeed}ms`;
			let section = document.querySelectorAll('.reveal .slides section');
			let slideBg = document.querySelectorAll('.reveal > .backgrounds .slide-background');
			let hasParallax = document.querySelectorAll('.reveal .has-parallax-background .backgrounds');
			setDomTransition(section,s);
			setDomTransition(slideBg,s);
			setDomTransition(hasParallax,s);
		} else {
